...
- (void)baseInit {
    _notSelectedStar = [UIImage imageNamed:@"ic_star_big_empty.png"];
    _selectedStar = [UIImage imageNamed:@"ic_star_big_full.png"];
    _halfSelectedStar = [UIImage imageNamed:@"ic_star_big_half.png"];
